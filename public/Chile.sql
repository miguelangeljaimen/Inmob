...
CREATE TABLE IF NOT EXISTS `comuna` (
  ...
  `nombre_comuna` varchar(20) DEFAULT NULL,
  `id_provincia` int(3) DEFAULT NULL,
  PRIMARY KEY (`id_comuna`),
  KEY `COMUNA_PROVINCIA_ID` (`id_provincia`)
...
INSERT INTO `region` (`id_region`, `nombre_region`, `ISO_3166_2_CL`) VALUES
(1, 'Tarapacá', 'CL-TA'),
(2, 'Antofagasta', 'CL-AN'),
(3, 'Atacama', 'CL-AT'),
(4, 'Coquimbo', 'CL-CO'),
...
--
ALTER TABLE `comuna`
  ADD CONSTRAINT `comuna_ibfk_1` FOREIGN KEY (`id_provincia`) REFERENCES `provincia` (`id_provincia`) ON UPDATE CASCADE;

--
-- Constraints for table `provincia`
--
ALTER TABLE `provincia`
  ADD CONSTRAINT `provincia_ibfk_1` FOREIGN KEY (`id_region`) REFERENCES `region` (`id_region`) ON UPDATE CASCADE;
COMMIT;
